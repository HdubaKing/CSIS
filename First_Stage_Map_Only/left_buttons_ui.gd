...
func _process(delta: float) -> void:
	$ButtonsContainer/Button1/Label.text = "Internal Government"
	$ButtonsContainer/Button2/Label.text = "Country List"
